  ...
  <div class="container mx-auto px-2 sm:px-4 p-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-8">
      ...
      <div class="space-y-16">
        <!-- Featured Post -->
        <div v-if="filteredPosts.length" @click="goToMain()" class="cursor-pointer">
          ...
          <div class="text-xs sm:text-sm text-gray-500 mt-2 flex flex-wrap items-center gap-2 justify-center">
          ...
          <div class="max-w-2xl mx-auto text-center mt-6 sm:mt-10">
            <p class="text-xs sm:text-sm uppercase tracking-wide text-gray-500">Life</p>
            <h1 class="text-xl sm:text-3xl font-bold mt-2 hover:text-blue-600 transition">
              {{ filteredPosts[0].title }}
            </h1>
            <p class="text-gray-700 mt-4 leading-relaxed text-sm sm:text-base">
              People know who they have the potential to be...
            </p>
            <button class="mt-4 sm:mt-6 px-4 sm:px-6 py-2 border border-black rounded-full text-black hover:bg-black hover:text-white transition-all delay-150 text-sm">
              READ MORE
            </button>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          >
            ...
            <p class="text-xs sm:text-sm uppercase tracking-wide text-gray-500 mt-2">
              {{ post.category }}
            </p>
            <h1
              @click="goToItem(post.id)"
            ...
            <div class="flex flex-wrap justify-center items-center gap-2 text-xs sm:text-sm text-gray-500 mt-2">
              <span><i class="fas fa-calendar-alt mr-1"></i> Apr 8, 2025</span>
            ...
            <button
              @click="goToItem(post.id)"
              class="mt-4 sm:mt-6 px-4 sm:px-6 py-2 border border-black rounded-full text-black hover:bg-black hover:text-white transition-all delay-150 text-sm"
            >
              READ MORE
            </button>
          </div>
